...
<body class="fixed-nav sticky-footer" id="page-top">
  ...
  $time = crud::select()::columns(["SemesterName", "grade_time"])::table("semesteryear");
    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <?php if ($_SESSION["role"] == "Faculty") : ?>
          <?php if (strtotime(date("m/d/Y")) <= strtotime($time["grade_time"])) : ?>
            <div class="col-12">
              <div class="alert alert-warning alert-dismissible fade show">
                <button type="button" class="close" data-dismiss="alert">&times;</button>
                <b>Notice!</b> You can assign grades to students for courses till this date
                <b><?php echo date('F d, Y', strtotime($time['grade_time'])); ?></b>
              </div>
            </div>
          <?php endif; ?>
        <?php endif; ?>
        <div class="col-12">
          <!-- Content -->
          <div class="card shadow p-0 bg-white mb-5">
            <div class="d-flex align-items-center p-3 border-bottom">
              <h4 class="m-0 font-20 align-middle">
                <i class="fa fa-check-circle text-success"></i> Grades
              </h4>
            </div>
  ...
  <script src="modules/classes/grades/js/data.js"></script>
</body>
