...
<head>
  ...
  <title>Majors requirements</title>
  <!-- Bootstrap core CSS-->
...
<body class="fixed-nav sticky-footer" id="page-top">
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb bg-transparent">
        ...
        <li class="breadcrumb-item active">Majors requirements</li>
      </ol>
      <div class="row">
        <div class="col-12">
          <!-- Content -->
          <div class="card shadow p-0 bg-white">
            <div class="d-flex align-items-center p-3 border-bottom">
              <h4 class="m-0 font-20 align-middle">
                <i class="fa fa-th text-success"></i> Majors requirements
              </h4>
            ...
            <table class="table table-card table-sm mb-0">
              <thead class="bg-light border-top">
                <tr>
                  ...
                  <th class="border-0" scope="col">Major</th>
  ...
  <script src="modules/courses/majorreq/js/data.js"></script>
</body>
