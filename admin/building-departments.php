...
<head>
  ...
  <title>Building deparments</title>
  <!-- Bootstrap core CSS-->
...
<body class="fixed-nav sticky-footer" id="page-top">
          ...
          <div class="card shadow p-0 bg-white">
            <div class="d-flex align-items-center p-3 border-bottom">
              <h4 class="m-0 font-20 align-middle">
                <i class="fa fa-building text-success"></i> Departments
              </h4>
            ...
            <table class="table table-card table-sm mb-0">
              <thead class="bg-light border-top">
                <tr>
                  ...
                  <th class="border-0" scope="col">Chairman</th>
                  <th class="border-0" scope="col">Manager</th>
                  <th class="border-0" scope="col">Building</th>
                  <th class="border-0" scope="col">Room #</th>
                  <th class="border-0" scope="col">Room Type</th>
  ...
  <script src="modules/buildings/departments/js/data.js"></script>
</body>
