...
<head>
    ...
    <title>Building lecture halls</title>
    <!-- Bootstrap core CSS-->
...
<body class="fixed-nav sticky-footer" id="page-top">
    ...
    <div class="content-wrapper">
        <div class="container-fluid">
            ...
            <ol class="breadcrumb bg-transparent">
                ...
                <li class="breadcrumb-item active">Lecture halls</li>
            </ol>
            <div class="row">
              <div class="col-12">
                  <!-- Content -->
                  <div class="card shadow p-0 bg-white">
                    <div class="d-flex align-items-center p-3 border-bottom">
                      <h4 class="m-0 font-20 align-middle">
                        <i class="fa fa-building text-success"></i> Lecture halls
                      </h4>
                    ...
                    <table class="table table-card table-sm mb-0">
                      <thead class="bg-light border-top">
                        ...
                        <th class="px-3 border-0" scope="col" >ID</th>
                          ...
                          <th class="border-0" scope="col" >Room number</th>
                          <th class="border-0" scope="col" >Capacity</th>
  ...
  <?php require_once 'includes/footer.php'; ?>
    ...
    <script src="modules/buildings/halls/js/data.js"></script>
</body>
